...
<div class="panel panel-default">
    <div class="panel-heading">添加上游账户</div>
    <div class="panel-body">
        <form method="post" action="{{ route('upaccount.store') }}" class="layui-form form-container form-horizontal form-ajax">
        ...
        $(document).ready(function () {
            $('.upstyle').on('change', function(data){
                ...
                if (typeof (stylelist[tid]) != 'undefined') {
                    ...
                    let selected = '';
                    for (i in params) {
                        if (typeof (edit[t + '_' + params[i]['paramsen']]) != 'undefined') {
                            tmpstr = edit[t + '_' + params[i]['paramsen']];
                        } else {
                            tmpstr = '';
                        }
