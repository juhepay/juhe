...
<head>
    <meta charset="utf-8">
    <title>{{config('app.name') }}-会员登录</title>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="box">
                    ...
                    <form class="form-ajax form-horizontal" action="{{ route('member.login') }}" method="post" autocomplete="off">
                        <div class="form-group">
                            <input type="text" class="form-control" name="username" id="username" placeholder="登录账号" autocomplete="off" required>
                        </div>
                        <div class="form-group">
